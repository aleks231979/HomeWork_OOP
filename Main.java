...
//        System.out.println(k2.getPairs());
        ...
        if (step == 1) {
            ...
            //добавлял инфу по жене сына Михаила, т.к она с семьей не имеет кровной связи установилась связь только с
            //Михаилом. В консоль получил результат Браун Мария Сергеевна WIFE Белов Михаил Иванович
            System.out.println("----------------------------------------");
